...
polly = client("polly", 'us-east-1', aws_access_key_id="AKIAIGJMPWWCSWZA5KJQ", aws_secret_access_key="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")
...
client = Client('theopere85@gmail.com', 'aej3eiJe')
chatid = "100010919627111"
...
TOKEN = 'sY1gRyWeeZAAAAAAAAAACitCkChgByLq6aiuvZYpQ4wS3C8cyyT2hzPb3PQq2jze'
...
def speak(wordstosay):
    ...
    if "AudioStream" in response:
        with closing(response["AudioStream"]) as stream:
            data = stream.read()
            fo = open("/Users/declangray-mullen/Documents/HackUmass-Weekend/SpeakingAUI/pollyspeech.mp3", "w+")
        fo.write(data)
        fo.close()

    # output speech file - always same file
    inputstring = ["afplay", "/Users/declangray-mullen/Documents/HackUmass-Weekend/SpeakingAUI/pollyspeech.mp3"]
